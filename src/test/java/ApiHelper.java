...
public  class ApiHelper {
	...
	static int videoContentCode=1280;
	static int documentContentCode=1270;
	
	static int titleTypeQuestionCode=3321;

	static int inputTypeQuestionCode=3320;
	static int multipleTypeQuestionCode=1273;
	static int singleSelectionTypeQuestionCode=1272;
	static int singleSelectionTypeQuestionCode2=1271;
	...
	public void getContentBuilderOverViewModelAPiCall() throws JsonProcessingException
	 {
		// String ApiBaseUrl="https://e-label.humanfocus.org.uk/CBT_APIStg/api/cbt";
		 ...
		 RestAssured.baseURI=ApiBaseUrl;
			...
			insertContentToSection(moduleIDs[2],singleSelectionTypeQuestionCode2);
